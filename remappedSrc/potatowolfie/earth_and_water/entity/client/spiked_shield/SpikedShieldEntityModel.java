...
public class SpikedShieldEntityModel extends ShieldModel {
	...
	public void render(ItemStack stack, PoseStack matrices, MultiBufferSource vertexConsumers,
					   int light, int overlay, Material baseSprite, Material noPatternSprite,
					   MaterialSet spriteHolder) {
		Material spriteToUse = (noPatternSprite != null) ? noPatternSprite : baseSprite;

		VertexConsumer vertexConsumer = spriteHolder.get(spriteToUse).wrap(
				vertexConsumers.getBuffer(RenderTypes.entityCutoutNoCull(spriteToUse.atlasLocation()))
		);
