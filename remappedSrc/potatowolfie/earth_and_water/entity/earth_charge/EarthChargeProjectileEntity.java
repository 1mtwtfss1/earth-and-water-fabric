...
public class EarthChargeProjectileEntity extends AbstractArrow {
    ...
    protected void onHitBlock(BlockHitResult result) {
        switch (result.getDirection()) {
            case SOUTH -> groundedOffset = new UVPair(215f, 180f);
            case NORTH -> groundedOffset = new UVPair(215f, 0f);
            case EAST -> groundedOffset = new UVPair(215f, -90f);
            case WEST -> groundedOffset = new UVPair(215f, 90f);
            case DOWN -> groundedOffset = new UVPair(115f, 180f);
            case UP -> groundedOffset = new UVPair(285f, 180f);
        }
