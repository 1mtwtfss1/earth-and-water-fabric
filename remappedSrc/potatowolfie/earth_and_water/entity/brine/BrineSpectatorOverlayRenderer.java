...
public class BrineSpectatorOverlayRenderer {
    ...
    public static void renderBrineVision(GuiGraphics context, float tickDelta) {
        ...
        float entityYaw = brineEntity.getYRot();
    ...
    private static void renderLeftSideVision(GuiGraphics context, int x, int y, int width, int height, float yaw) {
    }

    private static void renderKelpCoveredVision(GuiGraphics context, int x, int y, int width, int height) {
        int fadeWidth = 20;
