...
public class ModTrimMaterials {
    ...
    public static Optional<Holder<TrimMaterial>> get(HolderLookup.Provider registries, ItemStack stack) {
        ProvidesTrimMaterial providesTrimMaterialComponent = (ProvidesTrimMaterial)stack.get(DataComponents.PROVIDES_TRIM_MATERIAL);
        return providesTrimMaterialComponent != null ? providesTrimMaterialComponent.unwrap(registries) : Optional.empty();
    }
