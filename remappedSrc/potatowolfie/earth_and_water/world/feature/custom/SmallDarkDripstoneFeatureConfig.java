...
public class SmallDarkDripstoneFeatureConfig implements FeatureConfiguration {
    public static final Codec<SmallDarkDripstoneFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        })).apply(instance, SmallDarkDripstoneFeatureConfig::new);
    });
    ...
    public SmallDarkDripstoneFeatureConfig(float chanceOfTallerDripstone, float chanceOfDirectionalSpread, float chanceOfSpreadRadius2, float chanceOfSpreadRadius3) {
